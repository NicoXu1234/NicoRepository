...
exports.default = {
  ...
  computed: {
    ...
    readonly: function readonly() {
      ...
      return !this.filterable || this.multiple || (!isIE && !this.visible && !this.isMobile);
    },
    iconClass: function iconClass() {
      var criteria = this.clearable && !this.selectDisabled && (this.inputHovering || this.isMobile) && !this.multiple && this.value !== undefined && this.value !== null && this.value !== '';
